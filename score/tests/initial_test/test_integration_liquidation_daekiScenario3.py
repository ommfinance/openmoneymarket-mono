...
class TestIntegrationDepositUSDb(IconIntegrateTestBase):
    ...
    def setUp(self):
        ...
        #test_account3 deposits 2000 ICX 
        self.depositICXAmount1 = 2000 * 10 ** 18 
        self._depositICX(self.depositICXAmount1, self.test_account3)

        #test_account2 borrows 660 ICX        
        self.borrowSICXAmount1 = 660 * 10 ** 18 
    ...
    def _liquidationCall(self, _loanPayoffAmount : int, _borrowerUser : KeyWallet, _liquidatorUser : KeyWallet) :
        ...
        print('_liquidatorUserInitial usdb amount after liquidation', self.getUserUSDbBalance(_liquidatorUser.get_address())/10**18)
        ...
        print('user3 usdb balance after', self.getUserUSDbBalance(self.test_account3.get_address())/10**18)
        print('oUSDb balance of borrower after', self.getUserOUSDbBalance(self.test_account2.get_address())/10**18)
