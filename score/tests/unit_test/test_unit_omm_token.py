...
class TestOmmToken(ScoreTestCase):
    ...
    def setUp(self):
        ...
        self.score = self.get_score_instance(OmmToken, self._owner, on_install_params={
    ...
    def test_transfer_should_able_to_transfer(self):
        ...
        with mock.patch.object(self.score, "now", return_value=100 * TIME):
            ...
            self.assertEqual(10 * EXA, self.score.available_balanceOf(_user))
            self.assertEqual(10 * EXA, self.score.available_balanceOf(self.test_account4))
